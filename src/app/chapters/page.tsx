  ...
  return (
    <main className="p-4 md:p-8">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-x-2 mb-8 relative">
        <div
          className={`absolute flex flex-col w-3/4 md:w-1/4 bg-secondary rounded-md md:bg-transparent md:sticky self-start p-6 md:p-0 space-y-4 left-0 top-0 md:top-0 ${
            menuOpen ? "block" : "hidden md:block"
          }`}
        >
          <h3 className="font-semibold mb-4">Filter your chapters</h3>
          <div className="mb-4">
            <h4 className="font-semibold my-2 text-sm">Alphabetically</h4>
            {alphabetical.map((chapter) => (
              <div key={chapter.value} className="flex items-center space-x-2">
                <Checkbox />
